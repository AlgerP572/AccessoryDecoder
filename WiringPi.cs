...
namespace WiringPi
{
    ...
    public class PiThreadInterrupts
    {
        ...
        [DllImport("libwiringPi.so", EntryPoint = "wiringPiISR")]
        public static extern int wiringPiDetachInterrupt(int pin);
    ...
    public class SPI
    {
        ...
        public static extern int wiringPiSPIDataRW(int channel, byte[] data, int len);  //char is a signed byte
    }
